...
Las cuentas personales son las que más alertas generaron. Esto lleva a preguntarse si las reglas utilizadas son coherentes con lo que se espera.
...
ggplot(kpi_regla, aes(x = reorder(id_regla_principal, -prop), y = prop, fill = id_regla_principal)) +
  ...
  labs(
    x     = "Regla principal",
    y     = "% de alertas",
    title = "Distribución de alertas por tipo de regla principal"
  ) +
  theme_cowplot()
